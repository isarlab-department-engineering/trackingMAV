...
class DenseActor(BasePolicy):
    ...
    def __init__(
        ...
        #NB: parte modificata --> latent_dim=last_layer_dim, latent_sde_dim=latent_sde_dim, log_std_init=log_std_init
        if self.use_sde:
    ...
    def get_action_dist_params(self, obs: th.Tensor) -> Tuple[th.Tensor, th.Tensor, Dict[str, th.Tensor]]:
        ...
        """
        #print('shape custo actor obs: ', obs.shape)
        #print('custo actor obs: ', obs)
...
class SACDensePolicy(SACPolicy):
    ...
    def make_actor(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> DenseActor:
        ...
        actor_kwargs ['features_dim'] = observation_space['actor'].shape[0]
    ...
    def make_critic(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> DenseContinuousCritic:
        ...
        if (type(observation_space) == gym.spaces.dict.Dict):
            ...
            critic_kwargs['features_dim'] = observation_space.shape[0]
